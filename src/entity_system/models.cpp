...
Models::Models()
{
  ...
  models[TRIANGLE_MODEL].pos[0] = glm::vec3( 5.0f,-5.0f,0.1f);
  models[TRIANGLE_MODEL].pos[1] = glm::vec3( 0.0f, 5.0f,0.1f);
  models[TRIANGLE_MODEL].pos[2] = glm::vec3(-5.0f,-5.0f,0.1f);
  models[TRIANGLE_MODEL].pos[3] = glm::vec3(-5.0f,-5.0f,-0.1f);
  models[TRIANGLE_MODEL].pos[4] = glm::vec3( 0.0f, 5.0f,-0.1f);
  models[TRIANGLE_MODEL].pos[5] = glm::vec3( 5.0f,-5.0f,-0.1f);
  models[TRIANGLE_MODEL].color[0] = glm::vec3(0.2f,0.2f,0.2f);
  models[TRIANGLE_MODEL].color[1] = glm::vec3(1.0f,1.0f,1.0f);
  models[TRIANGLE_MODEL].color[2] = glm::vec3(0.2f,0.2f,0.2f);
  models[TRIANGLE_MODEL].color[3] = glm::vec3(0.2f,0.2f,0.2f);
  models[TRIANGLE_MODEL].color[4] = glm::vec3(1.0f,1.0f,1.0f);
  models[TRIANGLE_MODEL].color[5] = glm::vec3(0.2f,0.2f,0.2f);
