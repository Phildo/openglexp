...
//front
Models::models[INV_CUBE_MODEL].pos[ 0] = glm::vec3( 1.0f,-1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[ 1] = glm::vec3( 1.0f, 1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[ 2] = glm::vec3(-1.0f, 1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[ 3] = glm::vec3( 1.0f,-1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[ 4] = glm::vec3(-1.0f, 1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[ 5] = glm::vec3(-1.0f,-1.0f, 1.0f);
...
//right
Models::models[INV_CUBE_MODEL].pos[ 6] = glm::vec3( 1.0f,-1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[ 7] = glm::vec3( 1.0f, 1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[ 8] = glm::vec3( 1.0f, 1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[ 9] = glm::vec3( 1.0f,-1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[10] = glm::vec3( 1.0f, 1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[11] = glm::vec3( 1.0f,-1.0f, 1.0f);
...
//back
Models::models[INV_CUBE_MODEL].pos[12] = glm::vec3(-1.0f,-1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[13] = glm::vec3(-1.0f, 1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[14] = glm::vec3( 1.0f, 1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[15] = glm::vec3(-1.0f,-1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[16] = glm::vec3( 1.0f, 1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[17] = glm::vec3( 1.0f,-1.0f,-1.0f);
...
//left
Models::models[INV_CUBE_MODEL].pos[18] = glm::vec3(-1.0f,-1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[19] = glm::vec3(-1.0f, 1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[20] = glm::vec3(-1.0f, 1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[21] = glm::vec3(-1.0f,-1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[22] = glm::vec3(-1.0f, 1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[23] = glm::vec3(-1.0f,-1.0f,-1.0f);
...
//up
Models::models[INV_CUBE_MODEL].pos[24] = glm::vec3( 1.0f, 1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[25] = glm::vec3( 1.0f, 1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[26] = glm::vec3(-1.0f, 1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[27] = glm::vec3( 1.0f, 1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[28] = glm::vec3(-1.0f, 1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[29] = glm::vec3(-1.0f, 1.0f, 1.0f);
...
//down
Models::models[INV_CUBE_MODEL].pos[30] = glm::vec3( 1.0f,-1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[31] = glm::vec3( 1.0f,-1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[32] = glm::vec3(-1.0f,-1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[33] = glm::vec3( 1.0f,-1.0f,-1.0f);
Models::models[INV_CUBE_MODEL].pos[34] = glm::vec3(-1.0f,-1.0f, 1.0f);
Models::models[INV_CUBE_MODEL].pos[35] = glm::vec3(-1.0f,-1.0f,-1.0f);
