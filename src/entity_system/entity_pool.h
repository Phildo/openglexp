...
const component_signature component_signature_geometry_gear_model = 32;
const component_signature component_signature_geometry_inv_cube_model = 64;
const component_signature component_signature_geometry_light_cube_model = 128;
const component_signature component_signature_geometry_screen_quad_model = 256;
const component_signature component_signature_geometry_triangle_model = 512;
...
GeometryComponent geometry_gear_model_components[MAX_ENTITIES]; int num_geometry_gear_model_components;
