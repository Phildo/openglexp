...
const component_signature component_signature_direction_component = 2;
const component_signature component_signature_geometry_component = 4;
const component_signature component_signature_hud_component = 8;
const component_signature component_signature_input_component = 16;
const component_signature component_signature_light_component = 32;
const component_signature component_signature_position_component = 64;
const component_signature component_signature_rotational_velocity_component = 128;
const component_signature component_signature_starting_direction_component = 256;
const component_signature component_signature_starting_position_component = 512;
const component_signature component_signature_starting_rotational_velocity_component = 1024;
const component_signature component_signature_starting_velocity_component = 2048;
const component_signature component_signature_velocity_component = 4096;
