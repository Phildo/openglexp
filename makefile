...
#MAKEMAKE<
OBJS=$(ODIR)/FLAT_utils.o $(ODIR)/basic_entity_factory.o $(ODIR)/basic_reconciler.o $(ODIR)/camera.o $(ODIR)/entity.o $(ODIR)/entity_pool.o $(ODIR)/entity_system.o $(ODIR)/game.o $(ODIR)/graphics.o $(ODIR)/input.o $(ODIR)/main.o $(ODIR)/mygl.o $(ODIR)/physics_component.o $(ODIR)/physics_solver.o $(ODIR)/scener.o $(ODIR)/world_component.o $(ODIR)/world_renderer.o 
...
$(ODIR)/basic_entity_factory.o: src/basic_entity_factory.cpp src/basic_entity_factory.h src/entity_factory.h src/entity.h src/entity_pool.h src/world_component.h src/gl_include.h src/physics_component.h src/FLAT_utils.h
	$(CC) $(CFLAGS) src/basic_entity_factory.cpp -o $(ODIR)/basic_entity_factory.o

$(ODIR)/basic_reconciler.o: src/basic_reconciler.cpp src/basic_reconciler.h src/entity.h src/entity_pool.h src/world_component.h src/gl_include.h src/physics_component.h
...
$(ODIR)/entity_pool.o: src/entity_pool.cpp src/entity_pool.h src/entity.h src/world_component.h src/gl_include.h src/physics_component.h
	$(CC) $(CFLAGS) src/entity_pool.cpp -o $(ODIR)/entity_pool.o

$(ODIR)/entity_system.o: src/entity_system.cpp src/entity_system.h src/entity_factory.h src/entity_pool.h src/entity.h src/world_component.h src/gl_include.h src/physics_component.h src/physics_solver.h src/basic_reconciler.h src/world_renderer.h src/mygl.h src/camera.h
...
$(ODIR)/world_renderer.o: src/world_renderer.cpp src/world_renderer.h src/mygl.h src/gl_include.h src/camera.h src/world_component.h src/FLAT_utils.h
