...
OUT = $(BINDIR)/app
TOUT = $(BINDIR)/test
OBJS = $(ODIR)/main.o $(ODIR)/game.o $(ODIR)/mygl.o $(ODIR)/input.o $(ODIR)/graphics.o $(ODIR)/entity_system.o $(ODIR)/entity_pool.o $(ODIR)/entity_factory.o $(ODIR)/basic_entity_factory.o $(ODIR)/entity.o $(ODIR)/physics_component.o $(ODIR)/render_component.o
...
$(ODIR)/entity_factory.o : $(SRCDIR)/entity_factory.cpp $(SRCDIR)/entity_factory.h $(SRCDIR)/entity_pool.h $(SRCDIR)/entity.h
	$(CC) $(CFLAGS) $(SRCDIR)/entity_factory.cpp -o $(ODIR)/entity_factory.o

$(ODIR)/basic_entity_factory.o : $(SRCDIR)/basic_entity_factory.cpp $(SRCDIR)/basic_entity_factory.h $(SRCDIR)/entity_factory.h $(SRCDIR)/entity_pool.h $(SRCDIR)/entity.h
...
$(ODIR)/physics_component.o : $(SRCDIR)/physics_component.cpp $(SRCDIR)/physics_component.h
	$(CC) $(CFLAGS) $(SRCDIR)/physics_component.cpp -o $(ODIR)/physics_component.o

$(ODIR)/render_component.o : $(SRCDIR)/render_component.cpp $(SRCDIR)/render_component.h
