...
#MAKEMAKE<
OBJS=$(ODIR)/basic_entity_factory.o $(ODIR)/bilboard_entity_factory.o $(ODIR)/camera_component.o $(ODIR)/entity_pool.o $(ODIR)/entity_system.o $(ODIR)/models.o $(ODIR)/FLAT_utils.o $(ODIR)/game.o $(ODIR)/input.o $(ODIR)/light_entity_factory.o $(ODIR)/main.o $(ODIR)/mygl.o $(ODIR)/physics_solver.o $(ODIR)/renderer.o $(ODIR)/world_renderer.o 

$(OUT) : $(OBJS)
	$(CC) $(LFLAGS) $(OBJS) -o $(OUT)

$(ODIR)/basic_entity_factory.o: src/basic_entity_factory.cpp src/basic_entity_factory.h src/entity_system/entity_factory.h src/entity_system/entity.h src/entity_system/entity_pool.h src/entity_system/components/camera_component.h src/entity_system/components/geometry_component.h src/entity_system/components/light_component.h src/entity_system/components/spacial_component.h src/FLAT_utils.h src/gl_include.h
	$(CC) $(CFLAGS) src/basic_entity_factory.cpp -o $(ODIR)/basic_entity_factory.o

$(ODIR)/bilboard_entity_factory.o: src/bilboard_entity_factory.cpp src/bilboard_entity_factory.h src/entity_system/entity_factory.h src/entity_system/entity.h src/entity_system/entity_pool.h src/entity_system/components/camera_component.h src/entity_system/components/geometry_component.h src/entity_system/components/light_component.h src/entity_system/components/spacial_component.h src/gl_include.h
...
$(ODIR)/game.o: src/game.cpp src/game.h src/mygl.h src/gl_include.h src/input.h src/entity_system/entity_system.h src/basic_entity_factory.h src/entity_system/entity_factory.h src/bilboard_entity_factory.h src/light_entity_factory.h
...
$(ODIR)/light_entity_factory.o: src/light_entity_factory.cpp src/light_entity_factory.h src/entity_system/entity_factory.h src/entity_system/entity.h src/entity_system/entity_pool.h src/entity_system/components/camera_component.h src/entity_system/components/geometry_component.h src/entity_system/components/light_component.h src/entity_system/components/spacial_component.h src/gl_include.h src/FLAT_utils.h
